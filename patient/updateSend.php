...
// function makeNotification(){
  ...
  $subject = "Updated scheduled appointment id:$apptid";

  // echo "appdatetime recieved == $apptdatetime ", gettype($apptdatetime),"   length   ",strlen($apptdatetime);
  $mail_body = "<p>Hello $practo_user,</p><p>This is a confirmation email for your updated appointment at $apptdatetime has been moved to $apptdatetime. Please ignore any further mails with the old appointment details.</p><p>Regards.</p><p>Practo Team.</p>";
